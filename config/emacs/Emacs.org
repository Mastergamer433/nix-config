          ...
          (list
           (make-mu4e-context
            ...
            :vars '((user-mail-address . "mg433@kimane.se")
                    ...
                    (smtpmail-smtp-server . "mx01.zyner.net")
...
#+begin_src emacs-lisp
  (defun keo/awesomewm-denote-new-note (title keywords subdirectory)
    (select-frame (make-frame '((name . "New-Note"))))
    (denote-create-note title (delete "" (split-string keywords)) nil (concat (denote-directory) subdirectory))
    (delete-other-windows))
#+end_src
